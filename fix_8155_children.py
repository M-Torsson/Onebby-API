...
# Categories to move under parent 8155 (Elettrodomestici cucina)
CHILDREN_IDS = [8384, 8385, 8386, 8330, 8387, 8389, 8334, 8388]
PARENT_ID = 8155

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأطفال للفئة 8155 (Elettrodomestici cucina)")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Elettrodomestici cucina")
...
# Update has_children for parent 8155
