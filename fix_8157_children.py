...
# Categories to move under parent 8157 (Informatica)
CHILDREN_IDS = [8352, 8392, 8393, 8394, 8395, 8396, 8397, 8398, 8399, 8400, 8401, 8402, 8403, 8404, 8405, 8406, 8407, 8408, 8409]
PARENT_ID = 8157

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأطفال للفئة 8157 (Informatica)")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Informatica")
...
# Update has_children for parent 8157
