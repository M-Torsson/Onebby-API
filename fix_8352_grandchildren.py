...
# Categories to move under parent 8352 (Computer portatili)
CHILDREN_IDS = [8442, 8443, 8440, 8441]
PARENT_ID = 8352

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأحفاد للفئة 8352 (Computer portatili) - المستوى الثالث!")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Computer portatili")
    print(f"\n✅ الفئة الفرعية: {parent_name} (ID: {PARENT_ID})")
    print(f"   تحت: Informatica (8157)")
else:
...
# Update has_children for parent 8352
