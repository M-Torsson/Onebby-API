...
# Categories to move under parent 8384 (Cottura cibi)
CHILDREN_IDS = [8323, 8332, 8324, 8428, 8429, 8329, 8430]
PARENT_ID = 8384

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأحفاد للفئة 8384 (Cottura cibi) - المستوى الثالث!")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Cottura cibi")
...
# Update has_children for parent 8384
