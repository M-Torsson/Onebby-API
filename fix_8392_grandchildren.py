...
# Categories to move under parent 8392 (Tablet e accessori)
CHILDREN_IDS = [8444, 8445]
PARENT_ID = 8392

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأحفاد للفئة 8392 (Tablet e accessori) - المستوى الثالث!")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Tablet e accessori")
...
# Update has_children for parent 8392
