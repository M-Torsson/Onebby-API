...
# Categories to move under parent 8153 (Audio video)
CHILDREN_IDS = [8368, 8454, 8369, 8370, 8371, 8372, 8373, 8374, 8375, 8376, 8377, 8378]
PARENT_ID = 8153

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأطفال للفئة 8153 (Audio video)")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Audio video")
...
# Update has_children for parent 8153
