...
# Categories to move under parent 8152 (Elettrodomestici incasso)
CHILDREN_IDS = [8295, 8296, 8297, 8298, 8300, 8299, 8301, 8304, 8305, 8306]
PARENT_ID = 8152

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأطفال للفئة 8152 (Elettrodomestici incasso)")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Elettrodomestici incasso")
...
# Update has_children for parent 8152
