...
# Categories to move under parent 8156 (Cura della persona)
CHILDREN_IDS = [8337, 8338, 8339, 8389, 8390, 8342, 8343, 8344, 8345, 8346, 8347, 8348, 8349, 8350, 8391]
PARENT_ID = 8156

headers = {"X-API-Key": API_KEY}

print("=" * 80)
print(f"تحديث الأطفال للفئة 8156 (Cura della persona)")
print("=" * 80)
...
if response.status_code == 200:
    ...
    parent_name = parent.get("name", "Cura della persona")
...
# Update has_children for parent 8156
